...
namespace SmartWaterMeter
{
    public class ImageProcess
    {
        ...
        /// <returns></returns>
        public Bitmap Graying(Bitmap bmp)
        {
            Color curColor;
            int ret = 0;
        ...
        /// <param name="bmp"></param>
        /// <returns></returns>
        public  Bitmap Smoothing(Bitmap bmp)
        {
            int ret1 = 0;
            int ret2 = 0;
            int ret3 = 0;
        ...
        /// <param name="bmp"></param>
        /// <returns></returns>
        public  Bitmap Meaning(Bitmap bmp)
        {
            int rIndex = 0;
        ...
        /// <param name="bmp"></param>
        /// <returns></returns>
        public  Bitmap Guassing(Bitmap bmp)
        {
            double nSigma = 0.2;
        ...
        /// <param name="bmp"></param>
        /// <returns></returns>
        public  Bitmap Edging(Bitmap bmp)
        {
        ...
        /// <param name="bmp"></param>
        /// <returns></returns>
        public  Bitmap GrayReverse(Bitmap bmp)
        {
            for (int i = 0; i < bmp.Width; i++)
            {
                for (int j = 0; j < bmp.Height; j++)
        ...
        /// </summary>
        public  double[] carCos = new double[] {1.000000, 0.999848, 0.999391, 0.998630, 0.997564, 0.996195, 0.994522, 0.992546, 0.990268, 0.987688, 0.984808, 0.981627,
        ...
        public  double[] carSin = new double[]{
        ...
        public  int Hough(Bitmap srcBmp)
        {
        ...
        /// <returns></returns>
        public  Bitmap VerticalCorrect(Bitmap bmp, int slope)
        {
            int height = bmp.Height;
            int width = bmp.Width;
        ...
        /// <returns></returns>
        public  Bitmap CutImage(Bitmap bmp, int ws, int we, int hs, int he)
        {
        ...
        /// <param name="bmp"></param>
        /// <returns></returns>
        public Bitmap HoughGradcir(Bitmap bmp)
        {
